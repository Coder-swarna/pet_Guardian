...
public class ShopCardView {
    ...
    private HBox createProductBox(ProductModelClass product) {
        ...
        decreaseButton.setOnAction(e -> decreaseQuantity(product, quantityField, totalLabel));
        increaseButton.setOnAction(e -> increaseQuantity(product, quantityField, totalLabel));
    ...
    private void increaseQuantity(ProductModelClass product, TextField quantityField, Label totalLabel) {
        ...
        totalLabel.setText("Total: ₹" + (Integer.parseInt(product.getPrice()) * (currentQuantity + 1)));
        updateSubtotalAndTotal();
    }

    private void decreaseQuantity(ProductModelClass product, TextField quantityField, Label totalLabel) {
        int currentQuantity = productQuantities.get(product);
